...
Estas dos funciones nos permiten simular lo que quer\'iamos. Con la constante \code{MAX\_DELAY} y un porcentaje de este valor elegido por el usuario, la funci\'on \code{delay()} duerme el thread esa cantidad de tiempo. 
